...
from ..models.client_reconciliation_transaction_type import (
    ClientReconciliationTransactionType,
)
from ..types import UNSET
from ..types import Unset

T = TypeVar("T", bound="ClientReconciliationTransaction")


@_attrs_define
class ClientReconciliationTransaction:
    """
    Attributes:
        type_ (ClientReconciliationTransactionType):  Example: transaction.
    ...
    type_: ClientReconciliationTransactionType
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        type_ = ClientReconciliationTransactionType(d.pop("type"))
        ...
        client_reconciliation_transaction = cls(
            type_=type_,
        ...
        client_reconciliation_transaction.additional_properties = d
        return client_reconciliation_transaction
