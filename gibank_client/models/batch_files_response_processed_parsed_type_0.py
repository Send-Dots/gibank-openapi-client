...
from ..models.batch_files_response_processed_parsed_type_0_url_malware_protection_status import (
    BatchFilesResponseProcessedParsedType0UrlMalwareProtectionStatus,
)
from ..types import UNSET
from ..types import Unset

T = TypeVar("T", bound="BatchFilesResponseProcessedParsedType0")


@_attrs_define
class BatchFilesResponseProcessedParsedType0:
    """
    Attributes:
        url (str | Unset): The URL to download the processed file content
        url_malware_protection_status (BatchFilesResponseProcessedParsedType0UrlMalwareProtectionStatus | Unset): The
            malware protection status of the file (if applicable)
    """

    url: str | Unset = UNSET
    url_malware_protection_status: (
        BatchFilesResponseProcessedParsedType0UrlMalwareProtectionStatus | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        batch_files_response_processed_parsed_type_0 = cls(
            url=url,
            url_malware_protection_status=url_malware_protection_status,
        )

        batch_files_response_processed_parsed_type_0.additional_properties = d
        return batch_files_response_processed_parsed_type_0
