...
from ..models.transaction_files_response_parse_virtual_type_0_url_malware_protection_status import (
    TransactionFilesResponseParseVirtualType0UrlMalwareProtectionStatus,
)
from ..types import UNSET
from ..types import Unset

T = TypeVar("T", bound="TransactionFilesResponseParseVirtualType0")


@_attrs_define
class TransactionFilesResponseParseVirtualType0:
    """
    Attributes:
        url (str | Unset): The URL to download the parsed file content (virtual)
        url_malware_protection_status (TransactionFilesResponseParseVirtualType0UrlMalwareProtectionStatus | Unset): The
            malware protection status of the file (if applicable)
    """

    url: str | Unset = UNSET
    url_malware_protection_status: (
        TransactionFilesResponseParseVirtualType0UrlMalwareProtectionStatus | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        transaction_files_response_parse_virtual_type_0 = cls(
            url=url,
            url_malware_protection_status=url_malware_protection_status,
        )

        transaction_files_response_parse_virtual_type_0.additional_properties = d
        return transaction_files_response_parse_virtual_type_0
