...
T = TypeVar("T", bound="SubclientOwnerUpdate")


@_attrs_define
class SubclientOwnerUpdate:
    """
    Example:
        {'title': 'Majority Shareholder', 'prong_percentage': 55, 'address': {'street_address_1': '456 Looking Glass
            Road'}}
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        subclient_owner_update.additional_properties = d
        return subclient_owner_update
