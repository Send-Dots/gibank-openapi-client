...
from ..models.batch_files_response_batch_parsed_type_0_url_malware_protection_status import (
    BatchFilesResponseBatchParsedType0UrlMalwareProtectionStatus,
)
from ..types import UNSET
from ..types import Unset

T = TypeVar("T", bound="BatchFilesResponseBatchParsedType0")


@_attrs_define
class BatchFilesResponseBatchParsedType0:
    """
    Attributes:
        url (str | Unset): The URL to download the parsed file content
        url_malware_protection_status (BatchFilesResponseBatchParsedType0UrlMalwareProtectionStatus | Unset): The
            malware protection status of the file (if applicable)
    """

    url: str | Unset = UNSET
    url_malware_protection_status: (
        BatchFilesResponseBatchParsedType0UrlMalwareProtectionStatus | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        batch_files_response_batch_parsed_type_0 = cls(
            url=url,
            url_malware_protection_status=url_malware_protection_status,
        )

        batch_files_response_batch_parsed_type_0.additional_properties = d
        return batch_files_response_batch_parsed_type_0
