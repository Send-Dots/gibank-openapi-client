...
from ..models.subclient_data_business_response_type import (
    SubclientDataBusinessResponseType,
)
from ..types import UNSET
from ..types import Unset

T = TypeVar("T", bound="SubclientDataBusinessResponse")


@_attrs_define
class SubclientDataBusinessResponse:
    """
    Attributes:
        type_ (SubclientDataBusinessResponseType):  Example: business.
        id (float | Unset): The subclient data business ID Example: 1.
        subclient_id (float | Unset): The subclient ID Example: 1.
        legal_name (str | Unset): Legal name of the business Example: Acme Corporation.
    ...
    type_: SubclientDataBusinessResponseType
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        type_ = SubclientDataBusinessResponseType(d.pop("type"))
        ...
        subclient_data_business_response = cls(
            type_=type_,
            id=id,
        ...
        subclient_data_business_response.additional_properties = d
        return subclient_data_business_response
