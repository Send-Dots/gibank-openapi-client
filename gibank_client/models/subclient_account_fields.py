...
T = TypeVar("T", bound="SubclientAccountFields")


@_attrs_define
class SubclientAccountFields:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        subclient_account_fields.additional_properties = d
        return subclient_account_fields
