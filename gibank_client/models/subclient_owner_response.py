...
T = TypeVar("T", bound="SubclientOwnerResponse")


@_attrs_define
class SubclientOwnerResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        subclient_owner_response.additional_properties = d
        return subclient_owner_response
