...
from ..models.client_reconciliation_account_type import ClientReconciliationAccountType
from ..types import UNSET
from ..types import Unset

T = TypeVar("T", bound="ClientReconciliationAccount")


@_attrs_define
class ClientReconciliationAccount:
    """
    Attributes:
        type_ (ClientReconciliationAccountType):  Example: account.
    ...
    type_: ClientReconciliationAccountType
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        type_ = ClientReconciliationAccountType(d.pop("type"))
        ...
        client_reconciliation_account = cls(
            type_=type_,
        ...
        client_reconciliation_account.additional_properties = d
        return client_reconciliation_account
