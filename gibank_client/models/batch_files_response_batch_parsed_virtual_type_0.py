...
from ..models.batch_files_response_batch_parsed_virtual_type_0_url_malware_protection_status import (
    BatchFilesResponseBatchParsedVirtualType0UrlMalwareProtectionStatus,
)
from ..types import UNSET
from ..types import Unset

T = TypeVar("T", bound="BatchFilesResponseBatchParsedVirtualType0")


@_attrs_define
class BatchFilesResponseBatchParsedVirtualType0:
    """
    Attributes:
        url (str | Unset): The URL to download the parsed file content (virtual)
        url_malware_protection_status (BatchFilesResponseBatchParsedVirtualType0UrlMalwareProtectionStatus | Unset): The
            malware protection status of the file (if applicable)
    """

    url: str | Unset = UNSET
    url_malware_protection_status: (
        BatchFilesResponseBatchParsedVirtualType0UrlMalwareProtectionStatus | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        batch_files_response_batch_parsed_virtual_type_0 = cls(
            url=url,
            url_malware_protection_status=url_malware_protection_status,
        )

        batch_files_response_batch_parsed_virtual_type_0.additional_properties = d
        return batch_files_response_batch_parsed_virtual_type_0
