...
T = TypeVar("T", bound="AttachmentCreateBase")


@_attrs_define
class AttachmentCreateBase:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        attachment_create_base.additional_properties = d
        return attachment_create_base
