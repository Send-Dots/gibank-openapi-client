...
from ..models.subclient_data_natural_person_response_type import (
    SubclientDataNaturalPersonResponseType,
)
from ..types import UNSET
from ..types import Unset

T = TypeVar("T", bound="SubclientDataNaturalPersonResponse")


@_attrs_define
class SubclientDataNaturalPersonResponse:
    """
    Attributes:
        type_ (SubclientDataNaturalPersonResponseType):  Example: natural_person.
        id (float | Unset): The subclient data natural person ID Example: 1.
        subclient_id (float | Unset): The subclient ID Example: 1.
        first_name (str | Unset): First name of the natural person Example: John.
        middle_name (None | str | Unset): Middle name of the natural person Example: Michael.
        last_name (str | Unset): Last name of the natural person Example: Doe.
    ...
    type_: SubclientDataNaturalPersonResponseType
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        type_ = SubclientDataNaturalPersonResponseType(d.pop("type"))
        ...
        subclient_data_natural_person_response = cls(
            type_=type_,
            id=id,
        ...
        subclient_data_natural_person_response.additional_properties = d
        return subclient_data_natural_person_response
