...
T = TypeVar("T", bound="WebhookSubscriptionFields")


@_attrs_define
class WebhookSubscriptionFields:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        webhook_subscription_fields = cls(
            id=id,
        ...
        webhook_subscription_fields.additional_properties = d
        return webhook_subscription_fields
