...
from ..models.transaction_files_response_raw_type_0_url_malware_protection_status import (
    TransactionFilesResponseRawType0UrlMalwareProtectionStatus,
)
from ..types import UNSET
from ..types import Unset

T = TypeVar("T", bound="TransactionFilesResponseRawType0")


@_attrs_define
class TransactionFilesResponseRawType0:
    """
    Attributes:
        url (str | Unset): The URL to download the raw file content
        url_malware_protection_status (TransactionFilesResponseRawType0UrlMalwareProtectionStatus | Unset): The malware
            protection status of the file (if applicable)
    """

    url: str | Unset = UNSET
    url_malware_protection_status: (
        TransactionFilesResponseRawType0UrlMalwareProtectionStatus | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        transaction_files_response_raw_type_0 = cls(
            url=url,
            url_malware_protection_status=url_malware_protection_status,
        )

        transaction_files_response_raw_type_0.additional_properties = d
        return transaction_files_response_raw_type_0
