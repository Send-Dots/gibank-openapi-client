...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/subclient/{subclient_id}/attachment/{attachment_id}".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Subclient: Update Attachment

     Update an existing Subclient attachment. Useful to change a Subclient attachment.
