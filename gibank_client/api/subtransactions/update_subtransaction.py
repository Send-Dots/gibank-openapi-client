...
from ...models.subtransaction_update import SubtransactionUpdate
...
def _get_kwargs(
    ...
    *,
    body: SubtransactionUpdate,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/subtransaction/{subtransaction_id}".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Subtransaction: Update
     ...
     Update an existing Sub Subtransaction. Useful to update subtransactions.

    ***Requires authorization.***

    Args:
        subtransaction_id (int):  Example: 1.
        body (SubtransactionUpdate):  Example: {'deleted': True}.
