...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/subtransaction/{subtransaction_id}/attachment/{attachment_id}".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Subtransaction: Update Attachment

     Update an existing Subtransaction attachment. Useful to change a Subtransaction attachment.
