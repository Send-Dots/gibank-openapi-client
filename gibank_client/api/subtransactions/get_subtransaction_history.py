...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/subtransaction/{subtransaction_id}/history".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Subtransaction: Get History

     Get subtransaction history, so actions that were logged regarding a certain subtransaction. Useful
    to understand what happened when with your subtransaction.
