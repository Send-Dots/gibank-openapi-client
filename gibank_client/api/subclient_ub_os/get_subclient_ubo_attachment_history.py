...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/subclient/{subclient_id}/owner/{subclient_owner_id}/attachment/{attachment_id}/history".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Subclient UBO: Get Attachment History

     Get Subclient UBO Attachment history
