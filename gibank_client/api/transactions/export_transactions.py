...
from ...models.export_transactions_create_user_type import (
    ExportTransactionsCreateUserType,
)
from ...models.export_transactions_export_type import ExportTransactionsExportType
from ...models.export_transactions_mode import ExportTransactionsMode
from ...models.export_transactions_not_state import ExportTransactionsNotState
from ...models.export_transactions_response import ExportTransactionsResponse
from ...models.export_transactions_state import ExportTransactionsState
from ...models.export_transactions_transfer_direction import (
    ExportTransactionsTransferDirection,
)
from ...models.export_transactions_transfer_type import ExportTransactionsTransferType
from ...models.export_transactions_type import ExportTransactionsType
...
def _get_kwargs(
    *,
    export_type: ExportTransactionsExportType,
    limit: int | Unset = 1000,
    offset: int | Unset = 0,
    id: str | Unset = UNSET,
    batch_id: float | Unset = UNSET,
    batch_external_key: str | Unset = UNSET,
    type_: ExportTransactionsType | Unset = UNSET,
    transfer_direction: ExportTransactionsTransferDirection | Unset = UNSET,
    transfer_type: ExportTransactionsTransferType | Unset = UNSET,
    state: ExportTransactionsState | Unset = UNSET,
    not_state: ExportTransactionsNotState | Unset = UNSET,
    user_id: float | Unset = UNSET,
    user_full_name: str | Unset = UNSET,
    create_user_type: ExportTransactionsCreateUserType | Unset = UNSET,
    ...
    mode: ExportTransactionsMode | Unset = UNSET,
...
) -> ErrorBody | ExportTransactionsResponse | None:
    if response.status_code == 200:
        response_200 = ExportTransactionsResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorBody | ExportTransactionsResponse]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """Transactions: Export
     ...
     Export transactions in differnt formats based on their IDs. Useful for any kind of reporting.
    ...
    ***Requires authorization.***
    ...
    Args:
        export_type (ExportTransactionsExportType):  Example: csv.
        ...
        type_ (ExportTransactionsType | Unset): The transaction type Example: icl.
        transfer_direction (ExportTransactionsTransferDirection | Unset): The direction of the
            transfer. `outbound` means money left your account, `inbound` means money was added to
            your account Example: outbound.
        transfer_type (ExportTransactionsTransferType | Unset): The transfer type, depends on the
        ...
        state (ExportTransactionsState | Unset): The state of the transfer (can be multiple (array
            or comma separated)) Example: created.
        not_state (ExportTransactionsNotState | Unset): The state the transfer should not be in
        ...
        user_full_name (str | Unset): The user full name (contains, case insensitive) Example: Max
            Mustermann.
        create_user_type (ExportTransactionsCreateUserType | Unset): The user type Example:
            client.
        ...
        mode (ExportTransactionsMode | Unset): How the transaction data should be returned.
...
def sync(
    ...
    ***Requires authorization.***
    ...
    Returns:
        ErrorBody | ExportTransactionsResponse
    """
