...
from ...models.create_transaction_subtransaction_link_body import (
...
def _get_kwargs(
    transaction_id: int,
    *,
    body: CreateTransactionSubtransactionLinkBody,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    """Transaction: Create Subtransaction Link

     Create a new transaction subtransaction link. Useful to link subtransactions to transactions.
