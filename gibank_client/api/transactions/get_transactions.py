...
from ...models.get_transactions_create_user_type import GetTransactionsCreateUserType
from ...models.get_transactions_mode import GetTransactionsMode
from ...models.get_transactions_not_state import GetTransactionsNotState
from ...models.get_transactions_state import GetTransactionsState
from ...models.get_transactions_transfer_direction import (
    GetTransactionsTransferDirection,
)
from ...models.get_transactions_transfer_type import GetTransactionsTransferType
...
def _get_kwargs(
    *,
    ...
    transfer_direction: GetTransactionsTransferDirection | Unset = UNSET,
    transfer_type: GetTransactionsTransferType | Unset = UNSET,
    state: GetTransactionsState | Unset = UNSET,
    not_state: GetTransactionsNotState | Unset = UNSET,
    user_id: float | Unset = UNSET,
    user_full_name: str | Unset = UNSET,
    create_user_type: GetTransactionsCreateUserType | Unset = UNSET,
    ...
    mode: GetTransactionsMode | Unset = UNSET,
...
def sync_detailed(
    *,
    ...
    """Transactions: Get
     ...
     Get transactions. Useful to find transactions of the past time period, or to check the transaction
    state.
    ...
    ***Requires authorization.***
    ...
    Args:
        ...
        type_ (GetTransactionsType | Unset): The transaction type Example: icl.
        transfer_direction (GetTransactionsTransferDirection | Unset): The direction of the
            transfer. `outbound` means money left your account, `inbound` means money was added to
            your account Example: outbound.
        transfer_type (GetTransactionsTransferType | Unset): The transfer type, depends on the
        ...
        state (GetTransactionsState | Unset): The state of the transfer (can be multiple (array or
            comma separated)) Example: created.
        not_state (GetTransactionsNotState | Unset): The state the transfer should not be in (can
            be multiple (array or comma separated)) Example: created.
        ...
        user_full_name (str | Unset): The user full name (contains, case insensitive) Example: Max
            Mustermann.
        create_user_type (GetTransactionsCreateUserType | Unset): The user type Example: client.
        ...
        mode (GetTransactionsMode | Unset): How the transaction data should be returned.
