...
from ...models.get_batches_create_user_type import GetBatchesCreateUserType
from ...models.get_batches_response_200 import GetBatchesResponse200
from ...models.get_batches_state import GetBatchesState
from ...models.get_batches_type import GetBatchesType
...
def _get_kwargs(
    *,
    ...
    offset: int | Unset = 0,
    id: str | Unset = UNSET,
    type_: GetBatchesType | Unset = UNSET,
    state: GetBatchesState | Unset = UNSET,
    external_key: str | Unset = UNSET,
    create_user_type: GetBatchesCreateUserType | Unset = UNSET,
...
) -> ErrorBody | GetBatchesResponse200 | None:
    if response.status_code == 200:
        response_200 = GetBatchesResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorBody | GetBatchesResponse200]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """Batches: Get
     ...
     Get batches. Useful to find batches of the past time period.
    ...
    ***Requires authorization.***
    ...
    Args:
        ...
        type_ (GetBatchesType | Unset): The batch type Example: icl.
        state (GetBatchesState | Unset): The state of the batch Example: created.
        external_key (str | Unset): The external_key of the batch Example: ABC123456789.
        create_user_type (GetBatchesCreateUserType | Unset): The user type Example: client.
...
def sync(
    ...
    ***Requires authorization.***
    ...
    Returns:
        ErrorBody | GetBatchesResponse200
    """
